...
import { Bookmark, FileText, Clock, MapPin, Globe, Trash2 } from "lucide-react";
              ...
              applications.map((app) => (
                ...
                >
                  ...
                  <div className="flex justify-between mb-3">
                    ...
                    <div>
                      ...
                      <h3 className="text-lg font-semibold">
                        {app.opportunity ? app.opportunity.title : app.title}
                      </h3>

                      <p className="text-sm text-slate-400">
                        {app.opportunity ? app.opportunity.organization : app.organizer}
                      </p>
                  ...
                  <p className="text-xs text-slate-400 mt-auto">
                    Applied on{" "}
                    {new Date(app.appliedDate || app.createdAt).toDateString()}
                  </p>


                  <Link
                    to={`/opportunity/${app.opportunity ? app.opportunity._id : app.opportunityId}`}
                    className="mt-4"
                  >
              ...
              saved.map((opp) => (
                ...
                >
                  ...
                  <div className="flex gap-4 text-xs text-slate-400 mt-auto mb-4">
                    ...
                    <span className="flex items-center gap-1">
                      {opp.isOnline ? <Globe size={14} /> : <MapPin size={14} />}
                      {opp.isOnline ? "Online" : opp.location}
                    </span>
